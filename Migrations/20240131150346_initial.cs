        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrainNum = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_Stations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_Stations_EndPoint",
                        column: x => x.EndPoint,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_Stations_StartPoint",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "RTonev@abv.bg", "Rosen", "Tonev", "pass123", "rr" });

            migrationBuilder.CreateIndex(
                name: "IX_News_StationId",
                table: "News",
                column: "StationId");
